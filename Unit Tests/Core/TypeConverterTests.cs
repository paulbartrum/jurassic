...
namespace UnitTests
{
    ...
    public class TypeConverterTests : TestBase
    {
        ...
        public void ToNumber()
        {
            ...
            Assert.AreEqual(100000000000.0,             TypeConverter.ToNumber(100000000000.0));
            Assert.AreEqual(-100000000000.0,            TypeConverter.ToNumber(-100000000000.0));
            Assert.AreEqual(10e20,                      TypeConverter.ToNumber(10e20));
            Assert.AreEqual(-10e20,                      TypeConverter.ToNumber(-10e20));
        ...
        public void ToInteger()
        {
            ...
            Assert.AreEqual(-1, TypeConverter.ToInteger(-1.9));
            Assert.AreEqual(2147483647, TypeConverter.ToInteger(100000000000.0));
            Assert.AreEqual(-2147483648, TypeConverter.ToInteger(-100000000000.0));
            Assert.AreEqual(2147483647, TypeConverter.ToInteger(10e20));
            Assert.AreEqual(-2147483648, TypeConverter.ToInteger(-10e20));
        ...
        public void ToInt32()
        {
            ...
            Assert.AreEqual(-1, TypeConverter.ToInt32(-1.9));
            Assert.AreEqual(1215752192, TypeConverter.ToInt32(100000000000.0));
            Assert.AreEqual(-1215752192, TypeConverter.ToInt32(-100000000000.0));
            Assert.AreEqual(-559939584, TypeConverter.ToInt32(10e20));
            Assert.AreEqual(559939584, TypeConverter.ToInt32(-10e20));
        ...
        {
            var engine = new ScriptEngine();
            Assert.AreEqual(0u, TypeConverter.ToUint32(Null.Value));
            Assert.AreEqual(0u, TypeConverter.ToUint32(Undefined.Value));
            Assert.AreEqual(0u, TypeConverter.ToUint32(null));
            Assert.AreEqual(0u, TypeConverter.ToUint32(false));
            Assert.AreEqual(1u, TypeConverter.ToUint32(true));
            Assert.AreEqual(0u, TypeConverter.ToUint32(+0.0));
            Assert.AreEqual(0u, TypeConverter.ToUint32(-0.0));
            Assert.AreEqual(1u, TypeConverter.ToUint32(1.0));
            Assert.AreEqual(1u, TypeConverter.ToUint32(1.9));
            Assert.AreEqual(4294967295u, TypeConverter.ToUint32(-1.9));
            Assert.AreEqual(1215752192u, TypeConverter.ToUint32(100000000000.0));
            Assert.AreEqual(3079215104u, TypeConverter.ToUint32(-100000000000.0));
            Assert.AreEqual(3735027712u, TypeConverter.ToUint32(10e20));
            Assert.AreEqual(559939584u, TypeConverter.ToUint32(-10e20));
            Assert.AreEqual(0u, TypeConverter.ToUint32(double.PositiveInfinity));
            Assert.AreEqual(0u, TypeConverter.ToUint32(double.NegativeInfinity));
            Assert.AreEqual(0u, TypeConverter.ToUint32(double.NaN));
            Assert.AreEqual(0u, TypeConverter.ToUint32(""));
            Assert.AreEqual(1u, TypeConverter.ToUint32("1.6"));
            Assert.AreEqual(4294967295u, TypeConverter.ToUint32("-1.6"));
            Assert.AreEqual(1u, TypeConverter.ToUint32("1"));
            Assert.AreEqual(1u, TypeConverter.ToUint32("+1.0"));
            Assert.AreEqual(4294967295u, TypeConverter.ToUint32("-1.0"));
            Assert.AreEqual(100u, TypeConverter.ToUint32("1.0e2"));
            Assert.AreEqual(8u, TypeConverter.ToUint32("4294967304"));
            Assert.AreEqual(2147483658u, TypeConverter.ToUint32("2147483658"));
            Assert.AreEqual(2147483659u, TypeConverter.ToUint32("6442450955"));
            Assert.AreEqual(0u, TypeConverter.ToUint32(engine.Boolean.Construct(false)));
            Assert.AreEqual(1u, TypeConverter.ToUint32(engine.Boolean.Construct(true)));
            Assert.AreEqual(1u, TypeConverter.ToUint32(engine.Date.Construct(1.0)));
            Assert.AreEqual(0u, TypeConverter.ToUint32(engine.Date.Construct(double.NaN)));
            Assert.AreEqual(0u, TypeConverter.ToUint32(engine.Number.Construct(0.0)));
            Assert.AreEqual(1u, TypeConverter.ToUint32(engine.Number.Construct(1.0)));
            Assert.AreEqual(0u, TypeConverter.ToUint32(engine.Object.Construct()));
            Assert.AreEqual(0u, TypeConverter.ToUint32(engine.String.Construct("")));
            Assert.AreEqual(0u, TypeConverter.ToUint32(engine.String.Construct("test")));
            Assert.AreEqual(1u, TypeConverter.ToUint32(engine.String.Construct("1.9")));
        }
        ...
        public void ToInt16()
        {
            ...
            Assert.AreEqual(-1, TypeConverter.ToInt16(-1.9));
            Assert.AreEqual(-6144, TypeConverter.ToInt16(100000000000.0));
            Assert.AreEqual(6144, TypeConverter.ToInt16(-100000000000.0));
        ...
        public void ToUint16()
        {
            ...
            Assert.AreEqual(59392, TypeConverter.ToUint16(100000000000.0));
            Assert.AreEqual(6144, TypeConverter.ToUint16(-100000000000.0));
        ...
        public void ToInt8()
        {
            ...
            Assert.AreEqual(-1, TypeConverter.ToInt8(-1.9));
            Assert.AreEqual(0, TypeConverter.ToInt8(100000000000.0));
            Assert.AreEqual(0, TypeConverter.ToInt8(-100000000000.0));
        ...
        public void ToUint8()
        {
            ...
            Assert.AreEqual(0, TypeConverter.ToUint8(100000000000.0));
            Assert.AreEqual(0, TypeConverter.ToUint8(-100000000000.0));
