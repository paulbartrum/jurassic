...
namespace UnitTests
{
    ...
    public class ExpressionTests : TestBase
    {
        ...
        public void ObjectLiteral()
        {
            ...
            Assert.AreEqual("SyntaxError", EvaluateExceptionType("x = {get a() { return 2 }, get a() { return 2 }}"));
            Assert.AreEqual("SyntaxError", EvaluateExceptionType("x = {set a(value) { }, set a(value) { }}"));
            Assert.AreEqual("SyntaxError", EvaluateExceptionType("x = {a: 1, get a() { return 2 }}"));
            Assert.AreEqual("SyntaxError", EvaluateExceptionType("x = {a: 1, set a(value) { }}"));
            Assert.AreEqual("SyntaxError", EvaluateExceptionType("x = {get a() { return 2 }, a: 1}"));
            Assert.AreEqual("SyntaxError", EvaluateExceptionType("x = {set a(value) { }, a: 1}"));
            ...
            Assert.AreEqual("SyntaxError", EvaluateExceptionType("'use strict'; var x = {a: 1, a: 2};"));
