...
namespace UnitTests
{
    ...
    public class RealWorldTests : TestBase
    {
        ...
        public void Showdown()
        {
            ...
            engine.ExecuteResource("RealWorld/Files/showdown.js");
        ...
        public void ColorConversion()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteResource("RealWorld/Files/color-conversion.js");
        ...
        public void sprintf()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteResource("RealWorld/Files/sprintf.js");
        ...
        public void MD5()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteResource("RealWorld/Files/md5.js");
        ...
        public void SHA1()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteResource("RealWorld/Files/sha1.js");
        ...
        public void SHA256()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteResource("RealWorld/Files/sha256.js");
        ...
        public void LZW()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteResource("RealWorld/Files/lzw.js");
        ...
        public void RSAEncrypt()
        {
            ...
            engine.ExecuteResource("RealWorld/Files/rsa.js");
            engine.Execute(@"
                var rsa = new RSAKey();
        ...
        public void Levenshtein()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteResource("RealWorld/Files/levenshtein.js");
        ...
        public void CoffeeScript()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteResource("RealWorld/Files/coffee-script.js");
        ...
        public void BigNumber()
        {
            ...
            engine.ExecuteResource("RealWorld/Files/bignumber.js");
            engine.EnableDebugging = true;
