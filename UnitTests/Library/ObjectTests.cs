...
namespace UnitTests
{
    ...
    public class ObjectTests : TestBase
    {
        ...
        {
            Assert.AreEqual(true, Evaluate("var a = {}; a.__proto__ = Math; a.__proto__ === Math"), message:"__proto__ with ===");
            Assert.AreEqual(true, Evaluate("var a = {}; a.__proto__ = Math; a.__proto__ === Object.getPrototypeOf(a)"), message: "__proto__ with Object.getPrototypeOf");
        }
