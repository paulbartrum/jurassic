...
//CHECK#1
try{
  n = Number.prototype.toString(37);
...
//CHECK#6
try{
  n = (new Number(Number.NaN)).toString(37);
...
//CHECK#7
try{
  n = (new Number(Number.POSITIVE_INFINITY)).toString(37);
...
//CHECK#8
try{
  n = (new Number(Number.NEGATIVE_INFINITY)).toString(37);
