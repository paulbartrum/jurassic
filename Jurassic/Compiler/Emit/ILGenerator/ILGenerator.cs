...
namespace Jurassic.Compiler
{
    ...
    internal abstract class ILGenerator
    {
        ...
        public virtual ISymbolHelper SymbolHelper
        { get; set;  }
        ...
        public void MarkSequencePoint(SourceCodeSpan span)
        {
            if (span == null)
                throw new ArgumentNullException(nameof(span));
            MarkSequencePoint(span.StartLine, span.StartColumn, span.EndLine, span.EndColumn);
        }
