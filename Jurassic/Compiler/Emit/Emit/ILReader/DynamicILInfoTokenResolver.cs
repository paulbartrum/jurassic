...
namespace ClrTest.Reflection {
    internal class DynamicILInfoTokenResolver : ITokenResolver {
        ...
        static DynamicILInfoTokenResolver() {
            ...
            s_scopeFi = Type.GetType("System.Reflection.Emit.DynamicILInfo").GetField("m_scope", s_bfInternal);
        ...
        public DynamicILInfoTokenResolver(DynamicILInfo dm)
        {
            m_scope = s_scopeFi.GetValue(dm);
        }
