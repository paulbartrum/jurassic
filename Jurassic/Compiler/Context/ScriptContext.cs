...
namespace Jurassic.Compiler
{
    ...
    internal abstract class ScriptContext
    {
        ...
        [ThreadStatic]
        private static System.Reflection.Emit.AssemblyBuilder assemblyBuilder;
        ...
        public void GenerateCode()
        {
            ...
            GenerateCode(generator, new OptimizationInfo());
            generator.Complete();
            ...
            if (moduleBuilder == null)
            {
                ...
                assemblyBuilder = System.Threading.Thread.GetDomain().DefineDynamicAssembly(new System.Reflection.AssemblyName("Debug"),
                ...
                moduleBuilder = assemblyBuilder.DefineDynamicModule("Module", System.IO.Path.GetFileName(filePath), true);
            }

            // Create a new type to hold our method.
            var typeBuilder = moduleBuilder.DefineType("JavaScriptClass" + typeCount.ToString(), System.Reflection.TypeAttributes.Public | System.Reflection.TypeAttributes.Class);
            typeCount++;
            ...
            if (this.Path != null)
                optimizationInfo.DebugDocument = moduleBuilder.DefineDocument(this.Path, COMHelpers.LanguageType, COMHelpers.LanguageVendor, COMHelpers.DocumentType);
